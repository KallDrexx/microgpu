...
public class PacketFramerTests
{
    ...
    public static IEnumerable<object[]> ValidDecodeTestCases()
    {
        ...
        [
            new byte[]
            {
                0x02, 0x01, 0x03, 0x01, 0x40, 0x02, 0xF0, 0x01, 0x01, 0x01, 0x03, 0x01, 0x04, 0x01, 0x04, 0x02, 0x01,
                0x39, 0x00
            },
            new byte[]
            {
                0x01, 0x00, 0x01, 0x40, 0x00, 0xF0, 0x00, 0x00, 0x00, 0x00, 0x01, 0x04, 0x00, 0x00, 0x02
            }
        ];
    }
